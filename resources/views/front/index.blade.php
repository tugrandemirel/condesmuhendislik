...
@section('content')
    ...
    <section class="theme__main__banner black-bg pt-215 pb-205 pb-lg-100">
        ...
        @if(!is_null($_siteSetting->header_image))
            <img class="shapes shapes__1" src="{{ asset($_siteSetting->header_image) }}"
                 alt="{{ $_siteSetting->title }}">
        @endif
            ...
            <div class="row align-items-center">
                <div class="col-xl-9 col-lg-12">
                    <div class="theme__content text-xl-start text-center mb-5 mb-lg-0">
                        ...
                        <a href="{{ route('contact') }}" class="ht_btn"><span>Şimdi Keşfet <img
        ...
        @if($sliders->count() > 0)
            <div class="swiper hero__slider">
                ...
                <div class="swiper-button-prev"><img src="{{ asset('assets/front/img/icon/chevron-arrow-left.svg') }}"
                                                     alt="Arrow"></div>
                <div class="swiper-button-next"><img src="{{ asset('assets/front/img/icon/chevron-arrow-right.svg') }}"
                                                     alt="Arrow">
                </div>
            </div>
        @endif
    ...
    <section class="about__area">
        <div class="grey-bg about__section__wrapper pt-180 pb-70 pt-lg-120 pb-lg-30">
            ...
            <img class="about__shape__1" src="{{ asset('assets/front/img/shape/about-line-2a.svg') }}"
                 alt="About Shape">
            <img class="about__shape__2" src="{{ asset('assets/front/img/shape/about-line-3a.svg') }}"
                 alt="About Shape">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="single__box mb-30">
                            <div class="icon mb-35">
                                <img class="front-icon" src="{{ asset('assets/front/img/icon/icon-1a.svg') }}"
                                     alt="Icon">
                                <img class="back-icon" src="{{ asset('assets/front/img/icon/icon-1w.svg') }}"
                                     alt="Icon">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single__box mb-30">
                            <div class="icon mb-35">
                                <img class="front-icon" src="{{ asset('assets/front/img/icon/icon-2a.svg') }}"
                                     alt="Icon">
                                <img class="back-icon" src="{{ asset('assets/front/img/icon/icon-2w.svg') }}"
                                     alt="Icon">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single__box mb-30">
                            <div class="icon mb-35">
                                <img class="front-icon" src="{{ asset('assets/front/img/icon/icon-3a.svg') }}"
                                     alt="Icon">
                                <img class="back-icon" src="{{ asset('assets/front/img/icon/icon-3w.svg') }}"
                                     alt="Icon">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single__box mb-30">
                            <div class="icon mb-35">
                                <img class="front-icon" src="{{ asset('assets/front/img/icon/icon-4a.svg') }}"
                                     alt="Icon">
                                <img class="back-icon" src="{{ asset('assets/front/img/icon/icon-4w.svg') }}"
                                     alt="Icon">
                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="single__services__box mb-60">
                                            ...
                                            <div class="services__content">
                                                ...
                                                <a href="{{ route('service.detail', ['slug' => $service->slug]) }}"><img
                                                        src="{{ asset('assets/front/img/icon/long-arrow.svg') }}"
                                                        alt="Arrow"></a>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="chose__video__content" data-background="{{ asset($_siteSetting->home_first_image) }}">
                @if(!is_null($_siteSetting->home_first_url))
                    <div class="video__wrapper">
                        <a class="popup-video mb-30" href="{{ asset($_siteSetting->home_first_url) }}"><i
    ...
    <section class="counter__area">
        <div class="grey-bg counter__section__wrapper">
            <img class="shapes__1 d-none d-xl-inline-block" src="{{ asset('assets/front/img/shape/line-9a.svg') }}"
                 alt="Shape">
            <img class="shapes__2 d-none d-xl-inline-block" src="{{ asset('assets/front/img/shape/line-10a.svg') }}"
                 alt="Shape">
            <div class="container">
                <div class="row">
                            ...
                            @if(!is_null($_siteSetting->home_second_url))
                                <div class="video__wrapper">
                                    <img class="video__text"
                                         src="{{ asset('assets/front/img/video/video-text-circular.svg') }}"
                                         alt="Circular">
                    ...
                    <div class="col-lg-6">
                        <div class="faq__img__wrapper mb-30">
                            ...
                            @if(!is_null($_siteSetting->home_faq_main))
                                <img class="faq__img__main w-100" src="{{ asset($_siteSetting->home_faq_main) }}"
                                     alt="{{ $_siteSetting->title }}">
                            @endif
                            @if(!is_null($_siteSetting->home_faq_up))
                                <img class="faq__thumb1 d-none d-lg-inline-block"
                                     src="{{ asset($_siteSetting->home_faq_up) }}" alt="{{ $_siteSetting->title }}">
                            @endif
                            @if(!is_null($_siteSetting->home_faq_down))
                                <img class="faq__thumb2 d-none d-lg-inline-block"
                                     src="{{ asset($_siteSetting->home_faq_down) }}" alt="{{ $_siteSetting->title }}">
                            @endif
                        </div>
                    </div>
                </div>
                            ...
                            <div class="blog__one mb-30">
                                <div class="blog__thumb mb-25">
                                    <a href="{{ route('blog.detail', ['slug' => $blog->slug]) }}">
                                        <img class="w-100" src="{{ asset($blog->image) }}" width="410" height="320"
                                             alt="Blog"></a>
                                </div>
