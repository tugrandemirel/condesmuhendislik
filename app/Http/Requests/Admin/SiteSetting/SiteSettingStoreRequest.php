...
class SiteSettingStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'footer_image' => 'nullable|max:255|dimensions:max_width=1920,max_height=624',
    ...
    public function messages()
    {
        return [
            ...
            'footer_image.dimensions' => 'Lütfen geçerli bir resim boyutu giriniz. (Genişlik: 1920px, Yükseklik: 624px)',
